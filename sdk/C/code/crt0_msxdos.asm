	;--- crt0.asm for MSX-DOS
        ;
	;    Allows "int main(char** argv, int argc)",
...
cont:   ld      hl,#0x100
	...
	call    _main
        ...
        ;    Termination code for DOS 2 was returned on E by main
        ;    (int returns land in DE under the SDCC __sdcccall(1) ABI).
