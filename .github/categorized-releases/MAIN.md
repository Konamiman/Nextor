...
The [Nextor 3.0 documentation](https://github.com/Konamiman/Nextor/tree/v3.0/docs) includes a [Getting Started Guide](https://github.com/Konamiman/Nextor/blob/v3.0/docs/Nextor%203.0%20Getting%20Started%20Guide.md), the [User Manual](https://github.com/Konamiman/Nextor/blob/v3.0/docs/Nextor%203.0%20User%20Manual.md), the [Programmers Reference](https://github.com/Konamiman/Nextor/blob/v3.0/docs/Nextor%203.0%20Programmers%20Reference.md) and the [Driver Development Guide](https://github.com/Konamiman/Nextor/blob/v3.0/docs/Nextor%203.0%20Driver%20Development%20Guide.md).
