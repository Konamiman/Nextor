...
NEXTORJ.SYS is the variant of NEXTOR.SYS with Japanese messages;
to use it, delete NEXTOR.SYS and rename NEXTORJ.SYS to
NEXTOR.SYS.
...
Run any tool without arguments to get usage information. See the
