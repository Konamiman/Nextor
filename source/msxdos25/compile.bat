...
copy dos250ba.dat Nextor-2.0.1.base.dat
copy dos250ba.dat ..\..\bin\kernels\Nextor-2.0.1.base.dat
...
..\..\mknexrom  ..\..\Nextor-2.0.1.base.dat Nextor-2.0.1.%%~nc.ROM /d:driver.bin /m:chgbnk.bin
copy Nextor-2.0.1.%%~nc.ROM ..\..\..\..\bin\kernels
del b6.mac
del *.rom
cd ..
)
...
cd sdscc
..\..\mknexrom ..\..\Nextor-2.0.1.base.dat nextor2.rom /d:driver.bin /m:Mapper.ASCII8.bin
copy nextor2.rom ..\..\..\..\bin\kernels\Nextor-2.0.1.MegaFlashSDSCC.ROM
sjasm makerecoverykernel.asm kernel.dat
copy kernel.dat ..\..\..\..\bin\kernels\Nextor-2.0.1.MegaFlashSDSCC.Recovery.ROM
cd ..
