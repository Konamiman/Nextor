...
copy ..\bank0\b0labels.inc
for %%A in (B4,JUMP,ENV,CPM,BKALLOC,PARTIT,RAMDRV,TIME,SEG) do cpm32 M80 =%%A
cpm32 L80 /P:40FF,CODES,KVAR,DATA,B4,JUMP,ENV,CPM,BKALLOC,PARTIT,RAMDRV,TIME,SEG,/p:7fd0,chgbnk,B4/N/X/Y/E
...
copy dos250ba.dat Nextor-2.1-alpha1.base.dat
copy dos250ba.dat ..\..\bin\kernels\Nextor-2.1-alpha1.base.dat
...
..\..\mknexrom  ..\..\Nextor-2.1-alpha1.base.dat Nextor-2.1-alpha1.%%~nc.ROM /d:driver.bin /m:chgbnk.bin
copy Nextor-2.1-alpha1.%%~nc.ROM ..\..\..\..\bin\kernels
del b6.mac
del *.rom
cd ..
)
...
cd sdscc
..\..\mknexrom ..\..\Nextor-2.1-alpha1.base.dat nextor2.rom /d:driver.bin /m:Mapper.ASCII8.bin
copy nextor2.rom ..\..\..\..\bin\kernels\Nextor-2.1-alpha1.MegaFlashSDSCC.ROM
sjasm makerecoverykernel.asm kernel.dat
copy kernel.dat ..\..\..\..\bin\kernels\Nextor-2.1-alpha1.MegaFlashSDSCC.Recovery.ROM
cd ..
