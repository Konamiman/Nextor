...
..\..\mknexrom  ..\..\Nextor-2.0.5-beta1.base.dat Nextor-2.0.5-beta1.%%~nc.ROM /d:driver.bin /m:chgbnk.bin
...
cd sdscc
..\..\mknexrom ..\..\Nextor-2.0.5-beta1.base.dat nextor2.rom /d:driver.bin /m:Mapper.ASCII8.bin
