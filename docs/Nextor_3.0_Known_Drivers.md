...
The drivers that were part of Nextor 2 now live in their own dedicated GitHub repositories, which consume [the Nextor SDK](https://github.com/Konamiman/Nextor/blob/HEAD/sdk/README.md) and offer the downloadable ROM files in their releases sections; see the README file of each repository for the details and the build instructions.
